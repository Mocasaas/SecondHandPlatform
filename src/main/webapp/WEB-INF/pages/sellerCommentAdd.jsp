...
<head>
    ...
    <style>
        ...
        .star-group { display: flex; gap: 10px; font-size: 30px; cursor: pointer; margin: 20px 0; justify-content: center; }
...
<div class="container">
    <h2 style="text-align:center;">⭐ 评价卖家</h2>
...
<script>
    layui.use(['layer', 'jquery'], function() {
        ...
        $('#submitBtn').click(function() {
            ...
            $.ajax({
                url: '${pageContext.request.contextPath}/sellerComment/submit',
                type: 'POST',
                data: { orderId: orderId, sellerId: sellerId, rating: rating, content: content },
                dataType: 'json',
